package com.study.restapidemo.domain.reviews.controller;

import com.study.restapidemo.domain.reviews.entity.Review;
import com.study.restapidemo.domain.reviews.service.ReviewService;
...
public class ReviewController {
    ...
    public ResponseEntity<List<Review>> getReviewByBookId(@PathVariable Long bookId) {
